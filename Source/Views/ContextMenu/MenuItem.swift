...
class MenuItem: UIView {
    ...
    private let button: UIButton = {
        let button = UIButton(frame: CGRect(x: 0, y: 0 , width: MenuItem.vWidth, height: MenuItem.vHeight))
    ...
    let wrapper: UIView = {
        let view = UIView(frame: CGRect(x: 0, y: 0 , width: MenuItem.vWidth, height: MenuItem.vHeight))
    ...
    @objc public init(id: NSInteger, title: String, icon: UIImage?, data: Any? = nil) {
        super.init(frame: CGRect(x: 0, y: 0, width: MenuItem.vWidth, height: MenuItem.vHeight))
        self.id = id
        self.data = data
        self.title = title
